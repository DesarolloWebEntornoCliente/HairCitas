    ...
    <div class="container body">
    	...
    	<%
			if (session.getAttribute("usuLogeado") == null || session.isNew()) {
				...
				Servicio serv = sDAO.obtenerServicio(Integer.parseInt(request.getParameter("idServicio")));
      ...
      <div class="main_container">
		...
		<div class="row">
			<div class="col-md-8">
				...
				%>
				<hr>
				<form action="../EditarServicio?idServicio=<%=serv.getIdServicio()%>" class="form-horizontal" method="post">
			
					<div class="form-group">
						<label class="col-md-2 control-label" for="descripcion">Descripción</label>
						<div class="col-md-6">
							<input type="text" id="descripcion" name="descripcion" value="<%=serv.getDescripcion() %>"
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="number" id="tiempo" name="tiempo" value="<%=serv.getTiempo() %>"
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="number" id="precio" name="precio" value="<%=serv.getPrecio() %>"
								class="form-control input-md" required>
						</div>
					</div>					
					<br>
