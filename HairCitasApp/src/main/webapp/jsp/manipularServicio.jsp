				...
				<tr>
					...
					<td>
						...
						<button type="button" class="btn btn-warning" data-toggle="modal"
							data-target="#borrarServicio<%=serv.getIdServicio()%>">
							<i class="fa fa-times" aria-hidden="true"></i> Borrar
						</button> <!-- Modal -->
						<div class="modal fade" id="borrarServicio<%=serv.getIdServicio()%>"
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<div class="modal-footer">
										...
										<button type="button" class="btn btn-primary" onclick="location.href='../BorrarServicio?idServicio=<%=serv.getIdServicio()%>'">Sí</button>
									</div>
								</div>
							</div>
						</div>
