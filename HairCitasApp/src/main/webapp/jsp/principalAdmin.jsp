        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              ...
              <br>
              <a href="../index.jsp" class="site_title"><img src="../images/hairMin.jpg" alt="..." class="img-responsive "> <span>Hair Citas</span></a>
              </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="dashboard_graph">
                ...
                <div class="row x_title">
                  <div class="col-md-6">
                    <h3>Flujo de Actividad en la Página <small>Grafo del Ultimo Semestre</small></h3>
                  </div>
